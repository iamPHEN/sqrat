...
public:
    ...
    WeakFunction(const Function& sf) : vm(sf.vm), env(sf.env), obj(sf.obj) {
        //TODO
    }

    WeakFunction(const Object& e, const SQChar* slot) : vm(e.GetVM()), env(e.GetObject()) {
        //TODO
    }

	WeakFunction(HSQUIRRELVM v, HSQOBJECT e, HSQOBJECT o) : vm(v), env(e), obj(o) {
    ...
    WeakFunction& operator=(const Function& sf) {
        Release();
        vm = sf.vm;
        env = sf.env;
        obj = sf.obj;
